...
public class Marker {
	...
	public void paint(Graphics2D g) {
		...
		g.setColor(color);
		g.fillOval(line.xDataInt[xIndex] - 10, line.yDataInt[yIndex] - 10, 20, 20);
		g.setColor(Color.black);
		g.drawLine(line.xDataInt[xIndex] - 10, line.yDataInt[yIndex], line.xDataInt[xIndex] + 10, line.yDataInt[yIndex]);
		g.drawLine(line.xDataInt[xIndex], line.yDataInt[yIndex] - 10, line.xDataInt[xIndex], line.yDataInt[yIndex] + 10);
	}
	...
	public void mouseDragged(MouseEvent mouseEvent) {
		...
		//    System.out.println("markerDragged");
	}

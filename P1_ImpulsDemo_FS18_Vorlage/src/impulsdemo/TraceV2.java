...
public class TraceV2 {
	...
	private static boolean showMethod = false; // Zeigt nur Attribute & Konstruktor
	...
	public TraceV2(Object obj, boolean showObject) {
		this.className = obj.getClass().getName();
		this.hashCode = "" + obj.hashCode();
	...
	public TraceV2(String className, int hashCode) {
	...
	public TraceV2(String className, int hashCode, boolean showObject) {
		this.className = className;
		this.hashCode = "" + hashCode;
		this.showObject = showObject;
		if (show && (showBuild || showObject)) {
	...
	public TraceV2(String className, Object obj) {
		this.className = className;
		this.hashCode = "" + obj.hashCode();
		if (show && (showBuild || showObject)) {
			System.out.println("Attribute von " + className + "@" + hashCode + " werden initialisiert ...");
	...
	public TraceV2(String className, Object obj, boolean showObject) {
		this.className = className;
		this.hashCode = "" + obj.hashCode();
		this.showObject = showObject;
		if (show && (showBuild || showObject)) {
	...
	public static void mainCall(boolean show, boolean showBuild, boolean showMethode) {
		new TraceV2();
		TraceV2.show = show;
		TraceV2.showBuild = showBuild;
		TraceV2.showMethod = showMethode;

...
public class ParameterPanel extends JPanel implements ActionListener {
	...
	/**
	 * <pre>
	 * - Setzt bevorzugte Gr�sse auf (35% von DrehzeigerDemoApplikation.appWidth, 100% von DrehzeigerDemoApplikation.appHeight).
	...
	public ParameterPanel(Controller controller) {
		...
		add(cbLTI2Ord, new GridBagConstraints(0, 0, 2, 1, 0.0, 0.0, GridBagConstraints.LINE_START, GridBagConstraints.NONE,
		...
		add(cbLTIbel, new GridBagConstraints(0, 3, 2, 1, 0.0, 0.0, GridBagConstraints.LINE_START, GridBagConstraints.NONE,
				new Insets(5, 5, 5, 5), 0, 0));

		lbZaehler.setEnabled(false);
		tfZaehler.setEnabled(false);
		add(lbZaehler, new GridBagConstraints(0, 4, 1, 1, 0.0, 0.0, GridBagConstraints.LINE_START, GridBagConstraints.NONE,
				new Insets(5, 5, 5, 5), 0, 0));
		...
		add(lbNenner, new GridBagConstraints(0, 5, 1, 1, 0.0, 0.0, GridBagConstraints.LINE_START, GridBagConstraints.NONE,
				new Insets(5, 5, 5, 5), 0, 0));
		...
		add(btReset, new GridBagConstraints(0, 7, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
				new Insets(5, 5, 5, 5), 0, 0));
		...
		add(new JTextField(" sdfdsf "), new GridBagConstraints(0, 8, 2, 1, 0.0, 0.0, GridBagConstraints.CENTER,
	 ...
	 *   - Bei btReset Methode doClick() ausl�sen.
	...
	public void actionPerformed(ActionEvent e) {
		...
		// Falls (Quelle des Ereignisses gleich btReset) ODER (Quelle des Ereignisses
		// gleich btStart):
		// * - Falls cbLTIbel selektiert ist:
		...
		// jcbLTIType.getSelectedItem() aufrufen.
		// * - btReset() des Controllers aufrufen.
	...
	public static void main(String args[]) {
		SwingUtilities.invokeLater(new Runnable() {
			...
			public void run() {
				...
				frame.getContentPane().add(new ParameterPanel(new Controller()));
				frame.pack();

...
import drehzeigerdemo.gui.View;
import resources.Utility;

public class DrehzeigerDemoApplikation extends JFrame {
	...
	public DrehzeigerDemoApplikation() {
		getContentPane().add(view);
		pack();
		setTitle("Drehzeiger - Demo");
		setIconImage(icon);
	...
	public static void main(String args[]) {
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				...
				DrehzeigerDemoApplikation demo = new DrehzeigerDemoApplikation();

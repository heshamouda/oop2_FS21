...
public class ButtonPanel extends JPanel implements ActionListener {
	...
	public ButtonPanel(Controller controller) {
		...
		add(btBerechne, new GridBagConstraints(0, 0, 1, 1, 1.0, 1.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(10, 10, 10, 10), 0, 0));
		btBerechne.addActionListener(this);

		add(btReset, new GridBagConstraints(1, 0, 1, 1, 1.0, 1.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(10, 10, 10, 10), 0, 0));

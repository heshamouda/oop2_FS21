...
public class InputPanel extends JPanel implements ActionListener {
	...
	public InputPanel(Controller controller) {
		...
		add(tfAnzahlPunkte, new GridBagConstraints(1, 0, 1, 1, 1.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(10, 10, 10, 10), 0, 0));
		tfAnzahlPunkte.addActionListener(this);

		add(new JLabel("Maximale Punktzahl: "), new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(10, 10, 10, 10), 0, 0));
		add(tfMaxPunkte, new GridBagConstraints(1, 1, 1, 1, 1.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(10, 10, 10, 10), 0, 0));
		tfMaxPunkte.addActionListener(this);

		add(new JLabel("Note: "), new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
				GridBagConstraints.NONE, new Insets(10, 10, 10, 10), 0, 0));
		add(tfNote, new GridBagConstraints(1, 2, 1, 1, 1.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(10, 10, 10, 10), 0, 0));
	...
	public void update(Observable obs, Object obj) {
		...
		if (obs instanceof Model) {
			...
			double note = Math.round(model.getData() * 10.0) / 10.0;
			tfNote.setText("" + note);
			// tfNote.setText(Double.toString(note)); //Alternative
		}
	}
}

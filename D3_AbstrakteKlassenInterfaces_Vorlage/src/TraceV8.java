...
public class TraceV8 {
  ...
  public TraceV8(Object obj, boolean showObject) {
    this.className = obj.getClass().getName();
    String[] s = className.split("[.]+");
    className = s[s.length - 1];
    this.hashCode = "" + obj.hashCode();
  ...
  public TraceV8(String className, int hashCode) {
  ...
  public TraceV8(String className, int hashCode, boolean showObject) {
    this.className = className;
    this.hashCode = "" + hashCode;
    this.showObject = showObject;
    if (show && (showBuild || showObject)) {
  ...
  public TraceV8(String className, Object obj) {
    this.className = className;
    this.hashCode = "" + obj.hashCode();
    if (show && (showBuild || showObject)) {
      System.out.println("Attribute von " + className + "@" + hashCode + " werden initialisiert ...");
  ...
  public TraceV8(String className, Object obj, boolean showObject) {
    this.className = className;
    this.hashCode = "" + obj.hashCode();
    this.showObject = showObject;
    if (show && (showBuild || showObject)) {
  ...
  public void constructorCall() {
    if (show && (showBuild || showObject)) {
      System.out.println("Konstruktor " + className + "():" + className + "@" + hashCode + " wird ausgeführt ...");
  ...
  public void constructorCall(String constructor) {
    if (show && (showBuild || showObject)) {
      System.out.println("Konstruktor " + constructor + ":" + className + "@" + hashCode + " wird ausgeführt ...");
      appendToPane("Konstruktor " + className + "():" + className + "@" + hashCode + " wird ausgeführt ...",
          Color.BLACK);
    }
  }
  ...
  public void paintCall() {
    ...
    if (paintCount == 0 || paintCount % 1 == 0) {
      if (show && (showMethod || showObject)) {
        System.out.println("Methode " + className + "@" + hashCode + "." + methode + "()" + "(paintCount: " + paintCount
            + " ) wird ausgeführt ...");
        appendToPane("Methode " + className + "@" + hashCode + "." + methode + "()" + "(paintCount: " + paintCount
            + " ) wird ausgeführt ...", eventFarbe);
      }
    }
    paintCount++;
  }

  public void paintCall(int n) {
    String methode = getMethodName(3);
    if (paintCount == 0 || paintCount % n == 0) {
      if (show && (showMethod || showObject)) {
        System.out.println("Methode " + className + "@" + hashCode + "." + methode + "()" + "(paintCount: " + paintCount
            + " ) wird ausgeführt ...");
        appendToPane("Methode " + className + "@" + hashCode + "." + methode + "()" + "(paintCount: " + paintCount
  ...
  public void registerObserver(Object observable, Object observer) {
    ...
    if (show && (showMethod || showObject)) {
      System.out.println("Objekt " + classNameObserver + "@" + hashCodeObserver + " wird als Observer von " + "Objekt "
          + classNameObservable + "@" + hashCodeObservable + " registriert!");
    }
  }
...
//		}
  ...
  public static void mainCall(boolean show, boolean showBuild, boolean showMethode) {
    new TraceV8();
    TraceV8.show = show;
    TraceV8.showBuild = showBuild;
    TraceV8.showMethod = showMethode;
    System.out.println("Start via " + new CurrentClassGetter().getClassName() + "." + "main(String args[])");
    appendToPane("Start via " + new CurrentClassGetter().getClassName() + "." + "main(String args[])", Color.BLACK);
  }

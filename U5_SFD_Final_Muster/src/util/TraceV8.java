...
//		}
	...
	public static void appendToPane(String msg, Color c) {
		if (eventTextPane.getDocument().getLength() == 0) { // First time ...
			Border loweredetched = BorderFactory.createEtchedBorder(EtchedBorder.RAISED);
			Border titled = BorderFactory.createTitledBorder(loweredetched, "StatusBar");
			eventScrollPane.setBorder(titled);
			eventScrollPane.setPreferredSize(new Dimension(-1, 100));

...
public class TraceV3 {
	...
	public TraceV3(Object obj, boolean showObject) {
		this.className = obj.getClass().getName();
		this.hashCode = "" + obj.hashCode();
	...
	public TraceV3(String className, int hashCode) {
	...
	public TraceV3(String className, int hashCode, boolean showObject) {
		this.className = className;
		this.hashCode = "" + hashCode;
		this.showObject = showObject;
		if (show && (showBuild || showObject)) {
	...
	public TraceV3(String className, Object obj) {
		this.className = className;
		this.hashCode = "" + obj.hashCode();
		if (show && (showBuild || showObject)) {
			System.out.println("Attribute von " + className + "@" + hashCode + " werden initialisiert ...");
	...
	public TraceV3(String className, Object obj, boolean showObject) {
		this.className = className;
		this.hashCode = "" + obj.hashCode();
		this.showObject = showObject;
		if (show && (showBuild || showObject)) {
	...
	public void paintCall() {
		String methode = getMethodName(3);
		if (paintCount == 0 || paintCount % 100 == 0) {
			if (show && (showMethod || showObject)) {
	...
	public static void mainCall(boolean show, boolean showBuild, boolean showMethode) {
		new TraceV3();
		TraceV3.show = show;
		TraceV3.showBuild = showBuild;
		TraceV3.showMethod = showMethode;
